...
Parcelgen is no longer under active development by Yelp and is considered deprecated. As a replacement we advice to use [swagger-gradle-codegen](https://github.com/Yelp/swagger-gradle-codegen).
